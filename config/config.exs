...
config :artisan_connect,
  ecto_repos: [ArtisanConnect.Repo],
...
config :artisan_connect, ArtisanConnectWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: ArtisanConnectWeb.ErrorHTML, json: ArtisanConnectWeb.ErrorJSON],
    layout: false
  ],
...
config :artisan_connect, ArtisanConnect.Mailer, adapter: Swoosh.Adapters.Local
